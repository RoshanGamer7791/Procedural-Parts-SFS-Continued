	...
	SubShader
	{
		...
		Pass
		{
            ...
            #endif
            {
                ...
                // Adds distortion
                float offset = tex2D( _PerlinMap, float2( _Time.w, IN.texcoord.y * 0.2 * _Multiplier) ).r * 2 - 1; // -1 to 1 range
        
                x += offset * 1.2 * (1 - IN.texcoord.y);
